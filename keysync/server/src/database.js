...
pool.getConnection(function(err, con) {
  ...
  con.query(`CREATE TABLE IF NOT EXISTS ${process.env.PASSWORD_TABLE_NAME} (UserID int, Email varchar(254) UNIQUE, Password varchar(254), FOREIGN KEY (UserID) REFERENCES ${process.env.LOGIN_TABLE_NAME}(UserID));`);
